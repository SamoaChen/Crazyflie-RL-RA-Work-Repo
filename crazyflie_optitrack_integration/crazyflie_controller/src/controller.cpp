...
public:
        ...
        , m_startZ(0)
    {
        ...
        pub_error = nh.advertise<geometry_msgs::PoseStamped>("pose_error", 1);
    }
        ...
        case TakingOff:
            {
                ...
                float z_val = transform.getOrigin().z();
                if (z_val > 0.0 || m_thrust > 50000)  //previous value m_startZ + 0.1
                {
                    ROS_INFO_STREAM(z_val); // print out the z value
